"use strict";
(self["webpackChunkfausteditorweb"] = self["webpackChunkfausteditorweb"] || []).push([[1864],{
...
`;
    ...
    const {
      promises: fs
    } = await __webpack_require__.e(/* import() */ 2909).then(__webpack_require__.t.bind(__webpack_require__, 62909, 19));
    const {
      pathToFileURL
    } = await __webpack_require__.e(/* import() */ 871).then(__webpack_require__.t.bind(__webpack_require__, 40871, 19));
...
var FaustCmajor = class {
  ...
  compile(name, code, args) {
    ...
    return success ? fs.readFile(`${name}.cmajor`, {
      encoding: "utf8"
    }) : "";
  }
};
...
//# sourceMappingURL=64e07494bbc5c47c1999.js.map