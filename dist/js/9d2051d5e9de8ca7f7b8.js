"use strict";
(self["webpackChunkfausteditorweb"] = self["webpackChunkfausteditorweb"] || []).push([[3984,2096,9715],{
...
;// CONCATENATED MODULE: ./src/monaco-faust/Faust2MD.ts
...
;// CONCATENATED MODULE: ./src/monaco-faust/Faust2Doc.ts
...
;// CONCATENATED MODULE: ./src/monaco-faust/FaustLang.ts
              ...
              if (matched) {
                ...
                return {
                  ...
                  contents: [{
                    ...
                    value: prefix.length ? "[Detail...](".concat(documentation/* faustDocURL */.P, "/").concat(documentation/* docSections */.h[prefix.slice(0, 2).join("")], "/#").concat(prefix.join(".")).concat(doc.name.replace(/[[\]|]/g, "").toLowerCase(), ")") : "[Detail...](https://faustdoc.grame.fr/manual/syntax/index.html#faust-syntax)"
                  }]
                };
              }
              return null;
...
//# sourceMappingURL=9d2051d5e9de8ca7f7b8.js.map